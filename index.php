...
<div class="container"> <?php include_once __DIR__ . "/includes/navbar.php"; ?> <div class="slogan flex"></div>
    ...
    <div id="scenariosList" class="flex">
        ...
        <div id="carrusel" class="slider">
            <div id="carrusel-slides" class="slides"> <?php foreach ($resultats as $resultat): ?> <div class="slide">
                    <div class="scenario">
                        <div class="content">
                            ...
                            <a href="./scenario-
                                ...
                                <div class="content-details fadeIn-bottom">
                                    ...
                                    <div class="scenario-details flex">
                                        <div class="flex">
                              <span class="badge info"> <?= DIFFICULTY[
                                  $resultat["difficulty"]
                                  ] ?> </span>
                                        </div>
                                        <div class="flex">
                              <span class="badge info"> <?= $resultat[
                                  "min_players"
                                  ] ?>à <?= $resultat["max_players"] ?> joueurs </span>
                                        </div>
                                        <div class="flex">
                              <span class="badge info"> <?= $resultat[
                                  "time_mins"
