...
<html lang="en">
  <head>
    ...
    <!--XXXXXhyhyhyhyhX <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css"> -->
      ...
      <div class="subtitleStyle"><h2 class="subtitle">NOUS TROUVER</h2></div>
        ...
        <div class="informationMap">
          <div class="navigation">
            <p>Nous nous situons <span>7 Rue Paganel, 47000 Agen</span></p>
            <p>Tél: <a id="tel"></a></p>
